...
- PubMed/NCBI Entrez can be used as an evidence/reference layer. It should not
  be counted as a sequence-pair source unless the paper or supplement is parsed
  to recover paired binder and target sequences.
